...
echo "Starting simple UDP client..." . PHP_EOL;
...
if ($result === false) {
    echo "socket_bind() failed. " . PHP_EOL . "Reason: ($result) " . socket_strerror(socket_last_error($socket)) . PHP_EOL;
}
...
$payload = socket_read($socket, 1024);
